    ...
    <section id="product-memory" className="scroll-mt-28 border-t border-line px-5 py-12 sm:px-9 lg:px-10">
      <div className="overflow-hidden rounded-[18px] bg-ink text-canvas">
        <div className="grid gap-10 p-6 sm:p-8 lg:grid-cols-[0.58fr_0.42fr] lg:p-10">
          <div>
            <p className="text-sm font-semibold text-yellow">{productMemory.label}</p>
    ...
    <section id="contact" className="scroll-mt-28 px-5 py-20 sm:px-7 lg:px-9">
      <div className="mx-auto grid max-w-7xl gap-8 rounded-lg bg-ink p-6 text-canvas sm:p-8 lg:grid-cols-[0.62fr_0.38fr] lg:p-10">
        ...
        <div className="flex flex-col justify-end gap-3">
          <a className="text-base font-semibold underline decoration-accent underline-offset-8" href={`mailto:${person.email}`}>
            {person.email}
          </a>
          <a className="text-base font-semibold underline decoration-accent underline-offset-8" href={person.linkedin} target="_blank" rel="noreferrer">
            LinkedIn
          </a>
          <DownloadOpenLink
            className="text-base font-semibold underline decoration-accent underline-offset-8"
            href={person.resumeHref}
            download
          >
            Resume
    ...
    <main className="min-h-screen bg-[#eef1eb] px-3 py-3 text-ink sm:px-5 sm:py-5">
      <PortfolioFrame>
          ...
          <SectionIntro
            ...
            action={
              <a
                ...
                className="inline-flex min-h-10 items-center justify-center rounded-[12px] border border-line bg-surface px-5 text-sm font-semibold text-ink transition hover:border-accent focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-canvas"
              >
                Other work
              </a>
            }
        ...
        <section id="work" className="scroll-mt-28 border-t border-line px-5 py-12 sm:px-9 lg:px-10">
          <SectionIntro
            label="What I make clearer"
            title="The useful part is making product logic easier to run."
        ...
        <footer className="border-t border-line px-5 py-8 text-sm text-muted sm:px-9 lg:px-10">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap gap-5">
              ...
              <a href={person.linkedin} target="_blank" rel="noreferrer" className="transition hover:text-ink">
                LinkedIn
              </a>
